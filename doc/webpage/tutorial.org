...
mkdir illinois-sl
cd illinois-sl
wget http://cogcomp.cs.illinois.edu/software/illinois-sl/illinois-SL.0.2.2.zip
unzip illinois-SL.0.2.2.zip
#+END_SRC
...
\end{align*}
* References
**  Please cite the following paper when using the package:
